...
namespace TallerProgreso1.Controllers
{
    public class AutoesController : Controller
    {
        ...
        public AutoesController(TallerProgreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Marca,Puertas,color,anio")] Auto auto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Marca,Puertas,color,anio")] Auto auto)
        {
            if (id != auto.Id)
            {
                return NotFound();
